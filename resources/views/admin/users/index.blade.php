    ...
    <div class="mb-3 d-flex justify-content-between">
        <a href="{{route('users.add')}}"
           class="btn btn-info rounded-pill waves-effect waves-light d-flex align-items-center">
            Add New User <span class="btn-label-right"><i class="fas fa-plus-circle"></i></span>
        </a>
            ...
            @foreach($users as $user)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('users.edit', $user->id)}}" class="btn btn-info view-user rounded-pill waves-effect waves-light">
                            Edit
                        </a>
                    </td>
                </tr>
